...
def app(
    ...
    # NOTE: COOP/COEP removed — they block cross-origin iframes (e.g. ttyd
    # terminal).  SharedArrayBuffer won't be available but Flutter web still
    # works (CanvasKit falls back to single-threaded rendering).
